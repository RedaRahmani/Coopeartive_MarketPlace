...
// import hippoEmptyCart from './hippo.png'; // Correctly import the image
                ...
                >
                    ...
                    {loading ? (
                        ...
                        <div className="flex h-full flex-col items-center justify-center space-y-1">
                            ...
                            <div className="text-xl font-semibold">Your cart is empty</div>
                            <Link to="/" className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-full shadow-md transition duration-200 ease-in-out">
                                Add items to your cart to checkout
                            </Link>
                        </div>
                    ) : (
