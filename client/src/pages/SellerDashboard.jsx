...
//                 <tr className="transition-all duration-300 ease-in-out hover:bg-gray-100 transform hover:scale-105">
...
//                     ))}
//                   </td>
//                   {/* <td className="px-6 py-4 whitespace-nowrap">{order.items.reduce((sum, item) => sum + item.productQuantity, 0)}</td> */}
