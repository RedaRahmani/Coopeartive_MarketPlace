...
//           <h2 className="text-xl font-bold">We updated our cancellation policy to ensure the user experience</h2>
//           <Link to="/blog-post" className="text-blue-200 hover:underline">Explore updates</Link>
//         </div>
